            ...
            <div className={styles.notificationContainer} ref={notificationDropdownRef}>
              ...
              {showNotificationMenu && (
                <div className={styles.notificationDropdown}>
                  ...
                  <div style={{ padding: '1rem 1.25rem', textAlign: 'center', color: '#aaa' }}>
                    {timeLeft}
                  </div>
                </div>
              )}
          ...
          <div className={styles.mainMid}>
            ...
            <div className={styles.cardContainer}>
              ...
              >
                ...
                <h3 className={styles.cardTitle}>Saved Chapters</h3>
                <p className={styles.cardInfo}>Your saved Bible chapters</p>
                <p className={styles.cardInfo}>{savedCount} entries</p>
              </div>

              {/* Daily Reading Card Container - restored */}
              <div className={styles.card} tabIndex={0} role="button"
                onClick={() => {
